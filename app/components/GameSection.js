    ...
    <RevealSection id="game" className="w-full px-4 lg:px-16 xl:px-32 2xl:px-44 relative z-10 my-24 lg:my-32">
      <div className="w-full">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-stretch lg:justify-between">
          ...
          <Link href="/game" className="inline-flex w-fit lg:flex-shrink-0" aria-label="查看更多游戏">
            <div className="flex h-full items-center bg-orange-400 px-8 py-6 text-white shadow-[0_26px_52px_-34px_rgba(249,115,22,0.7)] transition-transform duration-300 hover:-translate-y-0.5 sm:px-10 sm:py-7">
